...
student_data(student_id="21102040")
student_data(student_id="21102040",student_name="Harshit Tyagi")
student_data(student_id="21102040",student_name="Harshit Tyagi",student_class="1st Year")
print()
